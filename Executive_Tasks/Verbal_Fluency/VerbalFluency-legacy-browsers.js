...
function VFinstruxRoutineBegin(snapshot) {
  return async function () {
    ...
    VFinstruxComponents.forEach( function(thisComponent) {
...
function VFinstrux_2RoutineBegin(snapshot) {
  return async function () {
    ...
    VFinstrux_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function getreadyVFRoutineBegin(snapshot) {
  return async function () {
    ...
    getreadyVFComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function VFRoutineBegin(snapshot) {
  return async function () {
    ...
    VFComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NextTrialVFRoutineBegin(snapshot) {
  return async function () {
    ...
    NextTrialVFComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
