...
function _settingsRoutineBegin(snapshot) {
  return async function () {
    ...
    _settingsComponents.forEach( function(thisComponent) {
...
function RAT_instruxRoutineBegin(snapshot) {
  return async function () {
    ...
    RAT_instruxComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RATinstrux_2RoutineBegin(snapshot) {
  return async function () {
    ...
    RATinstrux_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RATpractrialsLoopBegin(RATpractrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    RATpractrials.forEach(function() {
...
function RATblankRoutineBegin(snapshot) {
  return async function () {
    ...
    RATblankComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RATRoutineBegin(snapshot) {
  return async function () {
    ...
    RATComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RATpracAnsRoutineBegin(snapshot) {
  return async function () {
    ...
    RATpracAnsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RATinstrux_3RoutineBegin(snapshot) {
  return async function () {
    ...
    RATinstrux_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
