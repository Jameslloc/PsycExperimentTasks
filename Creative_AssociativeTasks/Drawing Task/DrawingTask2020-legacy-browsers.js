...
function Fake_TrialRoutineBegin(snapshot) {
  return async function () {
    ...
    Fake_TrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DrawInstruxRoutineBegin(snapshot) {
  return async function () {
    ...
    DrawInstruxComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DrawInstrux_3RoutineBegin(snapshot) {
  return async function () {
    ...
    DrawInstrux_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DrawingTrialRoutineBegin(snapshot) {
  return async function () {
    ...
    DrawingTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DrawInstrux_2RoutineBegin(snapshot) {
  return async function () {
    ...
    DrawInstrux_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
